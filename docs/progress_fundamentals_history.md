...
- **PER/PBR/ROE**: 年度別 EPS・BPS・ROE + 発表日を `kabutan_fundamentals` に保存。
...
- [x] 2. progress + DBスキーマ作成（kabutan_fundamentals テーブル）
...
- ステップ5完了: PER中央値18.5、ROE中央値8.0% で妥当。kabutan_fundamentals に16,331行格納。
