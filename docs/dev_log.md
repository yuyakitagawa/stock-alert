...
**実装:**
- Supabase に16テーブルを作成（yahoo_price_cache/held_scores/jquants_fin_summary/edinet_holdings 等）。
  daily_ranking→`web_rankings`、earnings_cache→`kabutan_earnings`、sector_cache→`web_stock_meta` に統合
