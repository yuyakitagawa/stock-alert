...
def main():
    ...
    # 実測（2026-08-19〜08-29）は34投稿・総インプレッション43・いいね0・リポスト0・
    # URLクリック1・フォロワー10日連続0で、リーチの3経路（フォロワーTL / X内検索 /
    # 他チャネル流入）がすべて塞がっている。再開条件は docs/x_operation_rules.md。
    # 投稿処理は web/x_client.py に残してあるので、再開はここから呼び直せばよい。
