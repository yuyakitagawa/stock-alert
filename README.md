...
| 3ヶ月相対強度 ≥ | +5%（通常相場） / +10%（下落相場）| 日経をアウトパフォームしている銘柄のみ |
| 20日相対強度 ≥ | 0% | 直近で日経に負けていない |
| セクター集中除外 | 同一業種3銘柄以上 | バブル兆候（一斉崩壊リスク）回避のためセクター全除外 |

**下落相場判定**: 日経225の20日リターン < -5% のとき3ヶ月相対強度閾値を引き上げ
...
- **新規候補 Top5**：スクリーナー上位・未保有銘柄（下落相場でも常時表示）
