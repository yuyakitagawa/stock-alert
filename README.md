...
（`DAILY_MAX_ARTICLES`）へ絞ったが、**2026-09-03に日次上限を撤去し、基準（5億円以上 or 1.5pt以上）を
満たす開示は全件記事にする運用へ戻した**（オーナー指示「開示案件は記事にしてほしい」。日2本では
開示の大半が記事にならず、TOPの「N件の開示」が実態より少なく見えていた）。便も平日9〜19時JSTの
