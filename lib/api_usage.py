...
# 2026-08-30に記事を日2本へ絞った際 1.2 → 0.15 へ下げたが、2026-09-03に日次上限を撤去して
# 基準を満たす開示を全件記事化する運用へ戻したので 1.2 へ戻した。
# 根拠: 記事本文1本の実測は $0.0092（api_usage、2026-08-29）。上限撤去前の実績は月平均
# 約26本/日（直近30日で対象1,041件のうち記事化789件、2026-08-28調査）で本文だけなら約$0.24、
# 未取得の会社説明（web_search込みで1社約$0.05）が乗る分を足しても $1.2 の中に収まる。
