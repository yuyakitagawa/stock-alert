...
# 2026-08-30にkujira-watchをGEOのA/B実験台へ切り替え、記事を日2本
# （publish_blog_articles.DAILY_MAX_ARTICLES）に絞ったのに合わせて 1.2 → 0.15 へ下げた。
# 根拠: 記事本文1本の実測は $0.0092（api_usage、2026-08-29）で2本なら約$0.02。
# これに未取得の会社説明（web_search込みで1社約$0.05）が2社ぶん乗っても約$0.12。
# 上限を実態の1桁上に置かないと、暴走したときの被害が実費の何十倍にもなる。
