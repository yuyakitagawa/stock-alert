...
このBotの機能（ユーザーに聞かれたら正確に案内すること）:
- 毎日夕方に自動でN225の投資/キャッシュ判定シグナルをLINE push通知する（定期プッシュ通知あり）
- ウォッチリストに登録した銘柄の買い時/売り時も同じ通知で届く
- LINEで話しかければ銘柄分析・相場相談ができる
- ウォッチリストの追加/削除/一覧もLINEから自然言語でできる
