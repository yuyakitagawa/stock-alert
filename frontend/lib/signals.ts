...
export const SIGNAL_COLORS: Record<string, { bg: string; text: string; border: string; dot: string; color: string }> = {
  ...
  "高値警戒":   { bg: "bg-yellow-900/40",  text: "text-yellow-300", border: "border-yellow-700", dot: "bg-[#eab308]", color: "#eab308" },
  ...
  "売り検討":   { bg: "bg-red-900/60",     text: "text-red-200",    border: "border-red-700",    dot: "bg-[#ef4444]", color: "#ef4444" },
