...
const CONDITIONS = {
  ja: [
    ...
    { label: "20日モメンタム",                          s: "≥ 0%",              a: "≥ 0%" },
    { label: "2年モメンタム",                           s: "プラス",            a: "プラス" },
    { label: "60日トレンド決定係数 R²",                 s: "≥ 0.2",             a: "≥ 0.2" },
    { label: "RSI (14日)",                             s: "45 〜 70",           a: "45 〜 70" },
    { label: "MA5 > MA25 (上昇トレンド)",               s: "必須",              a: "必須" },
    { label: "年率ボラティリティ",                       s: "22% 〜 25%",        a: "22% 〜 25%" },
  ...
  en: [
    ...
    { label: "20-day momentum",                         s: "≥ 0%",             a: "≥ 0%" },
    { label: "2-year momentum",                         s: "Positive",         a: "Positive" },
    { label: "60-day trend R² (coefficient of det.)",   s: "≥ 0.2",            a: "≥ 0.2" },
    { label: "RSI (14-day)",                            s: "45 – 70",          a: "45 – 70" },
    { label: "MA5 > MA25 (uptrend)",                    s: "Required",         a: "Required" },
    { label: "Annualized volatility",                   s: "22% – 25%",        a: "22% – 25%" },
