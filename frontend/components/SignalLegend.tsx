...
const CONDITIONS = {
  ja: [
    ...
    { label: "対応ETF前日リターン (XLK/XLF/XLI/XLB/XLV/XLY)", s: "プラスのみ", a: "—" },
  ],
  en: [
    { label: "Net Score (Rise prob − Drop prob)",      s: "17% ≤ net ≤ 24%",    a: "net ≥ 6%" },
    { label: "Drop probability",                       s: "< 4%",                a: "—" },
    { label: "Annualized volatility",                  s: "≤ 25%",               a: "—" },
    ...
    { label: "US sector ETF prev-day return (XLK/XLF/XLI/XLB/XLV/XLY)", s: "Positive only", a: "—" },
  ],
};
