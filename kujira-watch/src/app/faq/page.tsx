...
const FAQS: { question: string; answer: string; render?: React.ReactNode }[] = [
  ...
  },
  {
    ...
    answer:
      "保有割合が5%を超えることとなった日から、原則として5営業日以内に提出する義務があります。",
  },
  {
    question: "特定の日の動きだけを見るにはどうすればいいですか？",
    answer:
      "各記事のパンくずに表示されている取引日のリンクから、その日に開示された取引をまとめた取引日別ページに遷移できます。",
  },
  {
    question: "売り（保有比率の減少）による報告書も掲載していますか？",
    answer: "いいえ、現在は買い方向（新規取得・保有比率の増加）の開示のみを取り上げています。",
  },
  {
    question: "海外の投資家による大量保有報告書も対象ですか？",
    answer:
      "はい、国内外を問わず対象としています。提出者の分類には海外拠点の「外資系伝統運用会社」も含まれます。",
  },
  {
    question: "自社株買いやETFの資金フローも掲載されていますか？",
    answer:
      "いいえ、EDINETの大量保有報告書のみを対象としており、自社株買いやETFの資金フローは含まれていません。",
  },
  {
    question: "同じ銘柄・投資家で複数の記事があるのはなぜですか？",
    answer:
      "大量保有報告書は、保有比率が1%以上増減するたびに変更報告書として再提出されるため、同じ投資家・銘柄でも取引のたびに新しい記事を作成しています。",
  },
  {
    question: "サイト内検索はできますか？",
    answer:
      "いいえ、サイト内検索機能は提供していません。カテゴリ別一覧・銘柄別履歴・取引日別ページ・RSSフィードから記事をたどることができます。",
  },
  {
    question: "会員登録やログインは必要ですか？",
    answer: "いいえ、閲覧に会員登録・ログインは不要です。認証・会員機能は提供していません。",
  },
  {
    question: "記事にコメントを投稿できますか？",
    answer: "いいえ、コメント機能は提供していません。",
  },
  {
    question: "RSSで新着記事を購読できますか？",
    answer:
      "はい、新着記事20件のRSSフィードを配信しています。ヘッダーのハンバーガーメニューから購読できます。",
    render: (
      <>
        はい、
        ...
        を配信しています。ヘッダーのハンバーガーメニューから購読できます。
      </>
    ),
  },
  {
    ...
    answer:
      "過去にWeb検索で確認済みの投資家分類マスターをまず参照し、未登録の提出者のみAIが一般知識から判定して結果をマスターに保存しています。判定できない場合は「その他」に分類します。",
  },
  {
    question: "記事に付いているタグは何を表していますか？",
    answer:
      "記事本文に関連するキーワードを示す任意の項目で、記事末尾に表示されます（タグ別の一覧ページはありません）。",
  },
];
