...
export default function TermsPage() {
  return (
    <article className="border-t border-rule bg-paper p-6 sm:p-10">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-lg font-bold text-brand-navy">本サービスの内容</h2>
        <p className="text-sm leading-relaxed text-foreground/70">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-lg font-bold text-brand-navy">投資判断に関する免責</h2>
        <p className="text-sm leading-relaxed text-foreground/70">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-lg font-bold text-brand-navy">知的財産権</h2>
        <p className="text-sm leading-relaxed text-foreground/70">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-lg font-bold text-brand-navy">禁止事項</h2>
        <p className="text-sm leading-relaxed text-foreground/70">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-lg font-bold text-brand-navy">規約の変更</h2>
        <p className="text-sm leading-relaxed text-foreground/70">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-lg font-bold text-brand-navy">関連ページ</h2>
        <p className="text-sm leading-relaxed text-foreground/70">
          閲覧者の情報の取り扱いについては、
