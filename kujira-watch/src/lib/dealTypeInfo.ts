...
// 文字色のコントラストは背景トークン3種すべてでWCAG AA（通常テキスト4.5:1）を満たす。
// 実測の最小は --background 6.24:1 / --paper 6.57:1 / --section-tint 5.67:1（いずれも事業会社）。
// 色を触るときは最も濃い --section-tint 上で測ること（背景の中で唯一6:1を割る）。
//
